...
import { Search, Plus, FileText, Edit, Paperclip, Trash2, Download, FileSpreadsheet } from 'lucide-react';
                                    ...
                                    <TableCell>
                                        ...
                                        >
                                            <DropdownMenuItem
                                                icon={FileText}
                                                onClick={() => {
                                                    // View details - could open modal in view mode
                                                    handleEdit(expense);
                                                }}
                                            >
                                                View
                                            ...
                                            >
                                                {expense.receiptUrl ? 'Change Receipt' : 'Attach Receipt'}
                                            </DropdownMenuItem>
                                            <DropdownMenuItem
                                                icon={Trash2}
                                                variant="danger"
